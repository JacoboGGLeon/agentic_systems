...
from agentic_systems.providers import PythonDirectEngine, PythonDirectProvider
from agentic_systems.providers.python_direct import (
    _json_like,
    _parse_plan,
    _parse_pipeline,
...
def test_python_direct_handles_pipeline_and_input_errors():
