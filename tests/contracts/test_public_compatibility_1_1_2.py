...
EXPECTED_BEDROCK_RUNTIME_SIGNATURES = {
    "__init__": "(self, *, model_id: 'str', region_name: 'Optional[str]' = None, max_tokens_default: 'int' = 800, temperature_default: 'float' = 0.0, logger_name: 'str' = 'agentic_systems', disable_openai_runtime_tracing: 'bool' = True) -> 'None'",
    ...
    "as_openai_runtime_tools": "(self, tool_names: 'Optional[Sequence[str]]' = None) -> 'List[Any]'",
    "create_openai_agent": "(self, *, name: 'str', instructions: 'str', tool_names: 'Optional[Sequence[str]]' = None) -> 'Any'",
    "openai_runtime_model_provider": "(self) -> 'Any'",
    "run_openai_agent_sync": "(self, *, agent: 'Any', prompt: 'str', model_id: 'Optional[str]' = None, tool_choice: 'Optional[str]' = 'auto', max_tokens: 'Optional[int]' = None, temperature: 'Optional[float]' = None, max_turns: 'Optional[int]' = 12) -> 'Any'",
    "run_openai_agent": "(self, *, agent: 'Any', prompt: 'str', model_id: 'Optional[str]' = None, tool_choice: 'Optional[str]' = 'auto', max_tokens: 'Optional[int]' = None, temperature: 'Optional[float]' = None, max_turns: 'Optional[int]' = 12) -> 'Any'",
    "audit_openai_tool_outputs": "(self, result: 'Any') -> 'List[Dict[str, Any]]'",
    "openai_compact_trace": "(self, result: 'Any') -> 'Dict[str, Any]'",
    "validate_expected_tool_outputs": "(self, trace: 'Dict[str, Any]', expected: 'Dict[str, Any]') -> 'Dict[str, Any]'",
    "print_openai_audit": "(self, result: 'Any', *, trace_mode: 'str' = 'compact') -> 'None'",
...
def test_public_api_and_bedrock_exports_are_frozen_for_1_1_2():
    assert len(agentic_systems.__all__) == 111
...
def test_bedrock_runtime_public_signatures_are_frozen_for_1_1_2():
    public_method_names = {
        name
