...
```bash
python -m pip install --force-reinstall --no-deps ./agentic_systems-2.1.0-py3-none-any.whl
...
```bash
python -m semantic_challenges.strands_protocol_graph.run_matrix \
  --providers vllm-runtime --wheel ./agentic_systems-2.1.0-py3-none-any.whl
```
...
```bash
python -m semantic_challenges.strands_protocol_graph.run_matrix \
  --providers bedrock-runtime --wheel ./agentic_systems-2.1.0-py3-none-any.whl
